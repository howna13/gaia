<?php
function nova_reserva($username,$dia,$persones,$habitacio,$sopar,$esmorzar,$picnic){
	mysql_query("INSERT INTO reserves (habitacio,n_persones,username,dia,sopar,esmorzar,picnic)
	 			 VALUES ('$habitacio','$persones','$username','$dia','$sopar','$esmorzar','$picnic')");
}
...
function get_reserves($username){
	...
	$sql ="SELECT reserves.n_reserva, reserves.dia, reserves.n_persones,reserves.habitacio,reserves.sopar,reserves.esmorzar,reserves.picnic 
			FROM usuaris
			INNER JOIN reserves
